...
// テンプレート文字列を用いた方法
// const message2 = `私の名前は${name}でっせ。年齢は${age}です。`;
...
// const message2 = `名前は${name}です。年齢は${age}歳でっせ。`;
// console.log(message2);
...
// const [name, age] = myProfile;
// const message4 = `名前は${name}です。年齢は${age}歳でっせ。`;
...
// nameArr.map((name, a) => console.log(`${a + 1}番目は${name}です`));
